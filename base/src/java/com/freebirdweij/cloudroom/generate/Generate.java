...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/base/src/java/com/freebirdweij/cloudroom/generate/template", "/", separator);
		logger.info("Template Path: {}", tplPath);
		
		// Java文件路径
		String javaPath = StringUtils.replaceEach(projectPath+"/base/src/java/"+StringUtils.lowerCase(packageName), 
				new String[]{"/", "."}, new String[]{separator, separator});
		logger.info("Java Path: {}", javaPath);
		
		// 视图文件路径
		String viewPath = StringUtils.replace(projectPath+"/webapp/WEB-INF/views", "/", separator);
